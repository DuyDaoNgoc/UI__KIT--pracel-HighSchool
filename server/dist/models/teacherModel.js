...
*/
const AssignedClassSchema = new mongoose_1.Schema({
...
*/
TeacherSchema.index({ "assignedClass.classCode": 1 }, // trường index (nested path)
{
...
TeacherSchema.pre("save", async function (next) {
    ...
    if (!this.teacherId) {
        ...
        const TeacherModel = mongoose_1.default.model("Teacher");
